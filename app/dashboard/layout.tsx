...
const navigation = [
  { name: "Assistant", icon: Bot, href: "/dashboard#workspace" },
  { name: "Document Studio", icon: FileText, href: "/dashboard#workspace" },
  { name: "Research Studio", icon: Search, href: "/dashboard#workspace" },
